package com.pucminas.tcc.api.controllers;
...
import com.pucminas.tcc.api.dtos.LancamentoDto;
...
import com.pucminas.tcc.api.response.Response;
import com.pucminas.tcc.api.services.FuncionarioService;
import com.pucminas.tcc.api.services.LancamentoService;
...
public class LancamentoController {
	...
	public ResponseEntity<Response<List<LancamentoDto>>> listarTodosPorFuncionarioId(
		...
		List<LancamentoDto> lancamentosDto = lancamentos.stream()
				.map(lancamento -> this.converterLancamentoDto(lancamento)).collect(Collectors.toList());
